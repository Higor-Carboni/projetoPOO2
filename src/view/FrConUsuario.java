...
public class FrConUsuario extends javax.swing.JDialog {
    ...
    private void btnPesquisarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisarMouseClicked
        ...
        //preencher a grade
        //percorre os ususario e guarda a lista de usarios que encontro
        for (Usuario usu : listaUsuarios) {
            //cria um array onde cada posição é o valor das colunas de grade
            Object[] linha = {
                usu.getPkUsuario(),
                usu.getNome(),
                usu.getEmail(),
