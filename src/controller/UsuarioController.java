...
public class UsuarioController {
  ...
  public List<Usuario> consultar() {
      ...
      GerenciadorConexao gerencidor = new GerenciadorConexao();
      //cria as variaveis vazias antes do try pois vão ser usadas no finally
      PreparedStatement comando = null;
      ResultSet resultado = null;
      //crio a lista de usuairo vazia
      List<Usuario> listaUsuarios = new ArrayList<>();
      
      try {
          //Preparo do comando sql
          comando = gerencidor.prepararComando(sql);
          //Como não há parâmetros já executo direto
          resultado = comando.executeQuery();
          
          //irá percorrer ps registros do resultado do sql
          //a cada next(0 a variavel resultado aponta para o proximo registro
          //enquanto next() == true quer dizer que tem registros
          while (resultado.next()) {
              //crio um novo usuario vazio
              Usuario usuario = new Usuario();
              
              //leio as informações da variavel resultado e guardo no usurio
          ...
          gerencidor.fecharConexao(comando, resultado);
      }
